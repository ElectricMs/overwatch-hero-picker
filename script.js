...
// 数据来源：暴雪官方英雄页面，严格遵循游戏内角色队列设定
const heroes = {
    tank: [
        { name: 'D.Va', english: 'D.Va', emoji: '🎮', desc: '前职业玩家，驾驶机甲，用防御矩阵和微型飞弹攻击' },
        { name: '末日铁拳', english: 'Doomfist', emoji: '👊', desc: '手套可以发射冲击波，擅长近战和空中攻击' },
        { name: '金驭', english: 'Domina', emoji: '🎭', desc: '新英雄，精神控制大师，强大的重装英雄' },
    ...
    damage: [
        { name: '安燃', english: 'Anran', emoji: '🔥', desc: '新英雄，火焰力量与战斗技巧的结合，强大的输出英雄' },
        ...
        { name: '埃姆雷', english: 'Emre', emoji: '⚡', desc: '新英雄，能量操控专家，强力输出' },
        { name: '弗蕾娅', english: 'Freja', emoji: '🧊', desc: '新英雄，冰霜战士，控制战场的输出英雄' },
        { name: '源氏', english: 'Genji', emoji: '⚔️', desc: '赛博忍者，用忍者镖和龙刃斩击敌人' },
        { name: '半藏', english: 'Hanzo', emoji: '🏹', desc: '弓箭手，可以发射爬墙箭和巨龙撞击' },
        { name: '骇灾', english: 'Hazard', emoji: '☣️', desc: '新英雄，危险的化学武器专家，输出型英雄' },
        ...
        { name: '探奇', english: 'Venture', emoji: '⛏️', desc: '新英雄，探险家，擅长挖掘和探索，输出型英雄' },
        { name: '斩仇', english: 'Vendetta', emoji: '🗡️', desc: '新英雄，复仇的刺客，强大的输出英雄' },
    ...
    support: [
        ...
        { name: '飞天猫', english: 'Jetpack Cat', emoji: '🐱', desc: '新英雄，装备喷气背包的猫，支援型英雄' },
        { name: '朱诺', english: 'Juno', emoji: '🌙', desc: '新英雄，月亮女神，提供强力支援' },
        { name: '雾子', english: 'Kiriko', emoji: '🦊', desc: '忍者治疗师，用符咒和铃铛' },
        { name: '生命之梭', english: 'Lifeweaver', emoji: '🌸', desc: '泰坦科学家，用生命莲花治疗' },
        { name: '瑞稀', english: 'Mizuki', emoji: '🌸', desc: '新英雄，樱花武士，支援型英雄' },
